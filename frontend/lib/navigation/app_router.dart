...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return SharedDiaryEntryScreen(
          entry: entry is DiaryEntryModel
              ? entry
              : null,
        );
      },
    ...
    GoRoute(
      path:
          AppRoutes.adminTherapistDetail,
      builder: (context, state) {
        final id =
            state.pathParameters['id'];
